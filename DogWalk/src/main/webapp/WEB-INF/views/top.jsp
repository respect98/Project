...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" href="${myctx}/join">Join</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${myctx}/admin/userList">Users</a></li>
				<c:if test="${loginUser eq null }">
					<li class="nav-item"><a class="nav-link" href="#loginModal"
				...
				<li class="nav-item"><a class="nav-link"
					href="${myctx}/ajaxView">Spring Ajax</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${myctx}/fileForm">File Upload</a></li>
				<li class="nav-item"><a class="nav-link"
