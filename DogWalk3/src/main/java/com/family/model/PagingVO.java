...
public class PagingVO {
	...
	private int pageSize=5;//한 페이지 당 보여줄 목록개수
...
//		 start=end-(pageSize-1);
		 ...
		 * 11~15									10							16
		 * 
		 * prevBlock=(cpage-1)/pagingBlock * pageingBlock;
		 * nextBlock=prevBlock+(pagingBlock+1)
		 * 
		 */
	}
	public String getPageNavi(String myctx,String loc, String userAgent) {
		...
		if(prevBlock>0) {
			buf.append("<li class='page-item'>") //"/multiweb/board/list?capge=5"
