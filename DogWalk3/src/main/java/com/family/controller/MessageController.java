...
public class MessageController {
	...
	public String msgRePageView(String cp, String ps, Principal principal, Model model,HttpSession httpSession) {
	...
	public String msgSePageView(String cp, String ps, Principal principal, Model model,HttpSession httpSession) {
	...
	public String rPageView(String cp, String ps, Principal principal, Model model,HttpSession httpSession) {
	...
	// 쪽지>보낸사람 view
		...
		public String sPageView(String cp, String ps, Principal principal, Model model,HttpSession httpSession) {
		...
		public String detail(String msindex, Principal principal, Model model,HttpSession httpSession) {
		...
		// message > 글 삭제 처리
			...
			public String popRePage(String cp, String ps, Principal principal, Model model,HttpSession httpSession) {
