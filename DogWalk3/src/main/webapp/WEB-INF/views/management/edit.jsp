			...
			<div class="row">
				...
				<div class="col-8 area">
					...
					<div class="form-check">
						...
						<br>
						<label class="form-check-label">
							<input class="form-check-input" type="radio" name="petsize" id="size_small" value="small">
								소형
							<span class="circle">
								<span class="check"></span>
							</span>
						...
						<label class="form-check-label">
							<input class="form-check-input" type="radio" name="petsize" id="size_medium" value="medium">
								중형
							<span class="circle">
								<span class="check"></span>
							</span>
						...
						<label class="form-check-label">
							<input class="form-check-input" type="radio" name="petsize" id="size_big" value="big">
								대형
							<span class="circle">
								<span class="check"></span>
							</span>
		...
		$.ajax({
			...
			success: function(data) {
				...
				$.each(data, function(i, item) {
					if( ${pet.mcategory} == item.mcategory ) {
						option += "<option value='" + "${pet.mcategory}" + "' selected>" + item.mcaname + "</option>";
					} else {
	...
	function getSubCategory(mcaname) {
		...
		$.ajax({
			...
			success: function(data) {
				var option = "";
				$.each(data, function(i, item) {
					if( ${pet.scategory} == item.scategory ) {
						option += "<option value='" + "${pet.scategory}" + "' selected>" + item.scaname + "</option>";
					} else {
