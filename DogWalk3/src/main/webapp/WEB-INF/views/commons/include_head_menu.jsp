		...
		<div class="header-data">
			...
			<nav>
				<ul>
					...
					<li><a href="companies.jsp" title=""> <span><img
								src="images/icon2.png" alt=""></span> Companies
					</a>
						<ul>
							<li><a href="companies.jsp" title="">Companies</a></li>
							<li><a href="company-profile.jsp" title="">Company
									Profile</a></li>
						</ul></li>
					<li><a href="projects.jsp" title=""> <span><img
								src="images/icon3.png" alt=""></span> Projects
					</a></li>
					<li><a href="profiles.jsp" title=""> <span><img
					...
					<li><a href="jobs.jsp" title=""> <span><img
							...
							<div class="nott-list">
								<div class="notfication-details">
									...
									<div class="notification-info">
										<h3>
											<a href="messages.jsp" title="">Jassica William</a>
										</h3>
					...
					<li><a href="#" title="" class="not-box-open"> <span><img
								src="images/icon7.png" alt=""></span> Notification
					</a>
			...
			<div class="user-account">
				<div class="user-info">
					<img src="images/resources/user.png" alt=""> <a href="#"
						title="">John</a> <i class="la la-sort-down"></i>
				</div>
				<div class="user-account-settingss" id="users">
					...
					<h3>Setting</h3>
					<ul class="us-links">
						<li><a href="profile-account-setting.jsp" title="">Account
								Setting</a></li>
