			...
			<div class="row">
				<div class="col-12">
					<div class="tab-content tab-space">
						<div class="tab-pane active show" id="rPage">
							<div class="row justify-content-center">
								<div class="table-responsive">
								 <form action="delete.bit" method="get">
								    ...
								    <thead>
								   	 	<tr>
								             <th class="checkbox"  colspan="6" ><input type="checkbox" id="ck_all">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전체선택</th>
								        </tr>
								        <tr>
					...
					<ul class="pagination" id="pagingview">
						<c:if test="${cpage > 1}">
							<li class="page-item"><a class="page-link"
								href="msgRePage.bit?cp=${cpage-1}&ps=${pageSize}"
							...
							<c:choose>
								<c:when test="${cpage==i }">
									<li class="page-item active"><a class="page-link"
										href="msgRePage.bit?cp=${i}&ps=${pageSize}" cp="${i}"
										ps="${pageSize}">${i}</a></li>
								</c:when>
								<c:otherwise>
									<li class="page-item"><a class="page-link"
						...
						<c:if test="${cpage < pageCount}">
							...
							<li class="page-item">
								<a class="page-link" href="msgRePage.bit?cp=${cpage+1}&ps=${pageSize}"
