    ...
    <div class="table-box">
        ...
        <div class="ad-table manage">
            ...
            <table class="atable manage-table">
                ...
                <tbody>
                  <c:forEach var="member" items="${userinfo}">
                    <tr>
                        <td><a class="manage-btn" href="#">${member.userid}</a></td>
                        <td>${member.name}</td>
                        <td>${member.indate}</td>
                    </tr>
                      </c:forEach>
        ...
        <div class="new-article">
            ...
            <table class="atable article-table">
                ...
                <c:forEach var="vo" items="${boardList}">
                    <tr>
                        <td><a class="new_art"  href="<c:url value ='/board/JBoardDetail?board_no=${vo.cnum}&pet=${vo.pet}'/>">${vo.title}</a></td>
                        <td>${vo.nick}</td>
                        <td>${vo.cnt}</td>
                    </tr>
                   </c:forEach>
                ...
                <div class="mypage">
                        ...
                        <div class="mypage_form">
                            <div class="insert">
                                ...
                                <!--아이디-->
                                <div class="id_box">
                                    &nbsp;&nbsp;<p>아이디</p> <span class="userid">abc1234</span>
