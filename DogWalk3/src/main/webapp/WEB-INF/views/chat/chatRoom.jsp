...
<script type="text/javascript">
		...
		var user_nickname = "${sessionScope.member.nick}";
		
		var user_email = "${sessionScope.member.userid}";
	...
	function connect() {
		/*webSocket = new WebSocket(
				"ws://" + location.host + "/web/chat?room_number="+room_number);*/				
		/* webSocket=Stomp.over(socket); */
		webSocket=new SockJS("http://localhost:9090/web/chat?room_number="+room_number);
